    ...
    <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-primary/5 to-accent-turquoise/10">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="animate-fade-in stagger-2">
          {/* Title */}
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-playfair font-bold text-primary mb-6 animate-slide-in-up stagger-3">
            Sayo&apos;s Journal
          </h1>

          {/* Subtitle */}
          <p className="text-xl sm:text-2xl md:text-3xl font-noto-serif-jp text-text-primary mb-8 animate-slide-in-up stagger-4">
            &quot;空気と心&quot;を言葉に変える
          </p>

          {/* Decorative Divider */}
          <div className="flex items-center justify-center mb-8 animate-fade-in stagger-5">
          ...
          {/* Description */}
          <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl font-noto-serif-jp text-text-secondary leading-relaxed animate-slide-in-up stagger-6">
            人も、場所も、香りも、味も
            <br />
            私は、時間を超えた記憶を分かち合いたい
          </p>
      ...
      {/* Scroll Indicator */}
      <button
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-2 text-primary hover:text-primary-hover transition-colors duration-200 group animate-fade-in stagger-8"
